...
public class DAGLongestPath {
    ...
    public static void longestPathDAG(int n, List<List<Edge>> graph, int src) {
        int[] dist = new int[n];
        ...
        System.out.println("Longest paths from source " + src + ":");
        for (int i = 0; i < n; i++)
            System.out.println("Node " + i + " : " + (dist[i] == Integer.MIN_VALUE ? "INF" : dist[i]));
    }
